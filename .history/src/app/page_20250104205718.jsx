...
export default function HomePage() {
  ...
  <Link href="/projects">
    <button className="font-semibold py-[0.5rem] px-[1rem] mr-[1.5rem] border-none cursor-pointer hover:shadow-lg glow-btn">
      View Work
    </button>
  </Link>
  <Link href="/contact">
    <button className="font-semibold py-[0.5rem] px-[1rem] border-2 border-accent-color bg-transparent cursor-pointer hover:shadow-lg glow-btn">
      Contact Me
    </button>
  </Link>
</div>
...
<style >{`
  ...
  .glow-btn:hover {
    ...
    color: #00f9ff; /* Or any color you prefer for text */
  }
