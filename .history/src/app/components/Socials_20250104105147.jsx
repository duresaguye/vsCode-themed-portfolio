...
const Sidebar = () => {
  ...
  return (
    <aside className="bg-gray-800 flex flex-col justify-between h-[calc(100vh-55px)] w-[4.5vw] min-w-[40px] md:w-[6vw] lg:w-[8vw] sm:w-[10vw]">
      {/* Social Links */}
      ...
      <div className={styles.sidebarBottom}>
        {sidebarBottomItems.map(({ Icon, path }) => (
          <Link href={path} key={path} className={styles.iconContainer} legacyBehavior>
            <Icon
              style={{
