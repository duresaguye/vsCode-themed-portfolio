...
const explorerItems = [
  ...
  { name: 'about.html', path: '/about', icon: 'react_icon.svg' },
  { name: 'contact.css', path: '/contact', icon: 'react_icon.svg' },
  { name: 'projects.js', path: '/projects', icon: 'react_icon.svg' },
  { name: 'articles.json', path: '/articles', icon: 'react_icon.svg' },
