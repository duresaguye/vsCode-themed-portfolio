...
function InteractiveIllustration(props) {
  const [color, setColor] = useState("#D7F484");

  const handleHover = () => setColor("#FF6347"); // Change color on hover
  const handleLeave = () => setColor("#D7F484"); // Revert color on leave
  ...
  return (
    ...
    >
      <circle cx={167} cy={60} r={60} fill={color} />
