...
export default function Sidebar() {
  ...
  return (
    <div className="bg-gray-900 text-gray-300 w-16 sm:w-64 h-full p-4 flex flex-col sm:flex-row justify-between border-r border-gray-700">
      {/* Socials Section */}
      <div className="sm:w-1/2 w-full sm:mr-4 mb-4 sm:mb-0">
        <Socials />
      </div>

      {/* Explorer Section (Hidden on Small Screens) */}
